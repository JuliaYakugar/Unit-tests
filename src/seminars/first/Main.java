...
public class Main {
    public static void main(String[] args) {
         ...
         * .doesNotHaveDuplicates() // Массив не должен содержать повторяющихся
         * элементов
         * .contains("orange", "green", "violet") // Массив должен содержать цвета:
         * "orange", "green", "violet"
         * .endsWith("gold") // Последним цветом в массиве должен быть "gold"
         * .startsWith("aqua") // Первым цветом в массиве должен быть "aqua"
         * .containsSequence("yellow", "blue") // В массиве должна быть
         * последовательность цветов "yellow", "blue"
         * .doesNotContain("red", "black"); //Массив не должен содержать цвета: "red",
         * "black"
         */
    ...
    // Вот наиболее распространенный вариант использования. Предположим, вы
    // включаете значение enum:
    ...
    public static void checkingHero() {
         ...
         * 4. Проверить содержимое инвентаря героя (не пустой, размер 3, содержимое
         * "Bow", "Axe", "Gold", порядок не важен)
